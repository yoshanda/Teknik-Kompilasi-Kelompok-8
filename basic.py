...
class IllegalCharError(Error):
    def __init__(self, pos_start, pos_end, details):
        super().__init__(pos_start, pos_end, 'Tidak Dapat Membaca Karakter', details)
...
TT_INT		  = 'Bilangan Bulat'
TT_FLOAT    = 'Bilangan Desimal'
TT_PLUS     = 'Operator Tambah'
TT_MINUS    = 'Operator Kurang'
TT_MUL      = 'Operator Perkalian'
TT_DIV      = 'Operator Pembagian'
TT_LPAREN   = 'LPAREN'
TT_RPAREN   = 'RPAREN'
